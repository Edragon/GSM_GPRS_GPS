 ...
 *
 * RCS $Revision: 104125 $
 * Checkin $Date: 2006-10-31 15:00:01 +0000 (Tue, 31 Oct 2006) $
 * Revising $Author: cbaylis $
 *
...
#define __MKVECTORSTRUCT64(T,N) struct __simd64_##T { double __private; }; \
                                struct __library_simd64_##T { T a[N]; }
#define __MKVECTORSTRUCT128(T,N) struct __simd128_##T { double __private1, \
                                                         __private2; }; \
                                 struct __library_simd128_##T { T a[N]; }
...
#define __VECTOR64(typ, l) __MKVECTORSTRUCT64(typ##_t, l); \
                           typedef __VECTORSTRUCT64(typ##_t, l) __VECNAME(64,typ,l)
#define __VECTOR128(typ, l) __MKVECTORSTRUCT128(typ##_t, l); \
...
#define vshll_n_s8(a,b) __ndp2_wrk_qd_s16_s8_k((a),__is_constrange(0,7,b),0xf2880a10) // VSHLL.S8 q0,d0,#0
#define vshll_n_s16(a,b) __ndp2_wrk_qd_s32_s16_k((a),__is_constrange(0,15,b),0xf2900a10) // VSHLL.S16 q0,d0,#0
#define vshll_n_s32(a,b) __ndp2_wrk_qd_s64_s32_k((a),__is_constrange(0,31,b),0xf2a00a10) // VSHLL.S32 q0,d0,#0
#define vshll_n_u8(a,b) __ndp2_wrk_qd_u16_u8_k((a),__is_constrange(0,7,b),0xf3880a10) // VSHLL.U8 q0,d0,#0
#define vshll_n_u16(a,b) __ndp2_wrk_qd_u32_u16_k((a),__is_constrange(0,15,b),0xf3900a10) // VSHLL.U16 q0,d0,#0
#define vshll_n_u32(a,b) __ndp2_wrk_qd_u64_u32_k((a),__is_constrange(0,31,b),0xf3a00a10) // VSHLL.U32 q0,d0,#0
...
int16x8_t __ndp2_wrk_qd_s16_s8_k(int8x8_t,__constrange(0,7) int, __encoding_t);
...
int32x4_t __ndp2_wrk_qd_s32_s16_k(int16x4_t,__constrange(0,15) int, __encoding_t);
...
int64x2_t __ndp2_wrk_qd_s64_s32_k(int32x2_t,__constrange(0,31) int, __encoding_t);
...
uint16x8_t __ndp2_wrk_qd_u16_u8_k(uint8x8_t,__constrange(0,7) int, __encoding_t);
...
uint32x4_t __ndp2_wrk_qd_u32_u16_k(uint16x4_t,__constrange(0,15) int, __encoding_t);
...
uint64x2_t __ndp2_wrk_qd_u64_u32_k(uint32x2_t,__constrange(0,31) int, __encoding_t);
...
__EXTERNC __VALUE_IN_REGS int32x4_t vqdmull_lane_s16(int16x4_t vec1,
                                                     int16x4_t val2,
                                                     __constrange(0,3) int val3); // VQDMULL.S16 q0,d0,d0[0]
__EXTERNC __VALUE_IN_REGS int64x2_t vqdmull_lane_s32(int32x2_t vec1,
                                                     int32x2_t val2,
                                                     __constrange(0,1) int val3); // VQDMULL.S32 q0,d0,d0[0]
