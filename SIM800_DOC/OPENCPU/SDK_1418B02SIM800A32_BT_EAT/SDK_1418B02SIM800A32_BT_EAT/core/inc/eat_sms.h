 ...
 * Macros
 ********************************************************************/
 #define EAT_SMS_MAX_LEN                 176  //packed message conten length
 #define EAT_SMS_NAME_LEN                164   //receive phone name length
 #define EAT_SMS_DATA_TIME_LEN           25   //receive message date and time length
 #define EAT_SMS_DATA_LEN                640  //receive message string length
 #define EAT_SMS_NUMBER_LEN              164  //receive phone number length
