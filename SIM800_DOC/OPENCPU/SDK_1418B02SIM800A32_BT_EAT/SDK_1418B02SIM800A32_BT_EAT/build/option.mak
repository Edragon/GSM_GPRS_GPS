...
SRC_SCAT_FILE = scat_SIM800C32.txt
  ifeq ($(strip $(FEA_APP_MULTI_APP_INDEX_APP_OPT)),-D__EAT_SECOND_APP__)
    SRC_SCAT_FILE = scat_SIM800C32_SECOND.txt
  endif
HARDWARE_PLATFORM = SIM800C
endif

ifneq ("$(findstring 800F32,$(PROJ))","")
SRC_SCAT_FILE = scat_SIM800F32.txt
HARDWARE_PLATFORM = SIM800F
endif

ifneq ("$(findstring 800F32_GWDL,$(PROJ))","")
SRC_SCAT_FILE = scat_SIM800F32_GWDL.txt
HARDWARE_PLATFORM = SIM800F
endif

ifneq ("$(findstring 800A32,$(PROJ))","")
SRC_SCAT_FILE = scat_SIM800A32.txt
HARDWARE_PLATFORM = SIM800A
endif

ifneq ("$(findstring 800C32_BT_FS,$(PROJ))","")
SRC_SCAT_FILE = scat_SIM800C32_FS.txt
HARDWARE_PLATFORM = SIM800C
endif
