...
const char *sendtable="Bluetooth LED control\r\n\32";
...
void main(void)
{
	...
	}while(strstr((const char*)Uart1_Buf,"+BTSCAN: 0")==NULL);   //等待收索到设备才退出
	LED2=0;
	do
	{
	...
	}while(strstr((const char*)Uart1_Buf,"+BTPAIR: 1")==NULL);//匹配成功
	LED3=0;
